...
//     //MSVCRT$vsnprintf will return -1 on encoding failure (ex. non latin characters in Wide string)
//     if (buffersize == -1)
//         return;
...
// char* Utf16ToUtf8(const wchar_t* input)
// {
//     int ret = Kernel32$KERNEL32$WideCharToMultiByte(
//         CP_UTF8,
//         0,
//         input,
//         -1,
...
//     ret = Kernel32$KERNEL32$WideCharToMultiByte(
//         CP_UTF8,
//         0,
//         input,
//         -1,
